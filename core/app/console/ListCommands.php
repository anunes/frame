...
class ListCommands
{
    ...
    public function handle(array $arguments): void
    {
        ...
        echo "  \033[32mmake:module\033[0m <name> [--start] [--nav] Create a new user content module in files/\n";
        ...
        echo "\033[33mModules:\033[0m\n";
        echo "  \033[32mmodule:start\033[0m <name|--clear> Choose which module handles the home page\n";
        echo "  \033[32mmodule:delete\033[0m <name> --force Delete a user content module\n\n";
        ...
        echo "  php frame make:module employees --start --nav\n";
        echo "  php frame make:migration create_products_table\n";
        echo "  php frame migrate\n";
        echo "  php frame route:list\n";
        echo "  php frame module:start employees\n";
        echo "  php frame module:start --clear\n";
        echo "  php frame module:delete employees --force\n";
