                                    ...
                                    <label class="list-group-item d-flex gap-3 align-items-center"
                                        ...
                                        <div class="d-flex gap-3 w-100 align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="d-block text-muted">Follow your device appearance</small>
                                            </div>
                                        </div>
                                    </label>
...
<script>
    ...
    (function () {
        ...
        window.addEventListener('theme:change', (event) => {
            const preferredTheme = normalizeTheme(event.detail?.theme);
            const radio = document.getElementById(`theme-${preferredTheme}`);
