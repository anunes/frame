        ...
        <div class="col-md-12 mb-3">
            <div class="form-check form-switch">
                <input class="form-check-input"
                       type="checkbox"
                       role="switch"
                       id="show_get_in_touch_card"
                       name="show_get_in_touch_card"
                       @if($settings->show_get_in_touch_card) checked @endif>
                <label class="form-check-label" for="show_get_in_touch_card">
                    Show "Get In Touch" card on the contact page
                </label>
            </div>
            <small class="text-muted">Turn this off to show only the contact form.</small>
        </div>
    </div>
